...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    notification_id: 2,
    user_id: 1,
    content: "Your Organic Zucchini listing is expiring tomorrow. Update or close it before it expires.",
  ...
  },
  {
    notification_id: 3,
    user_id: 1,
    content: "Glen Kim left a 5-star review on your Strawberry Jam exchange.",
  ...
  },
  {
    notification_id: 4,
    user_id: 1,
    content: "Rose Johnson joined Mānoa Valley Garden Share.",
  ...
  },
  {
    notification_id: 5,
    user_id: 1,
    content: "You have a new message from Oliver Lee about Fresh Tomatoes.",
  ...
  },
  {
    notification_id: 6,
    user_id: 1,
    content: "Your claim for Meyer Lemons was approved by Rose Johnson.",
  ...
  },
  {
    notification_id: 7,
    user_id: 1,
    content: "Malia Nakamura requested to join Northside Pantry Network.",
  ...
  },
  {
    notification_id: 8,
    user_id: 1,
    content: "Your Fresh Tomatoes listing has been viewed 12 times today.",
...
export const mockThreads: MessageThread[] = [
  {
    ...
    participant_ids: [1, 2],
    messages: [
      { message_id: 1, thread_id: 1, sender_user_id: 2, content: "Hi! I'd love to pick up 3 lbs of tomatoes. Are they still available?", timestamp: "2026-07-01T10:30:00" },
      { message_id: 2, thread_id: 1, sender_user_id: 1, content: "Yes, still available! I'm usually home in the afternoons. Does tomorrow around 3pm work?", timestamp: "2026-07-01T11:15:00" },
      { message_id: 3, thread_id: 1, sender_user_id: 2, content: "That works perfectly. I'll come by around 3. Thanks so much!", timestamp: "2026-07-01T11:45:00" },
      { message_id: 4, thread_id: 1, sender_user_id: 1, content: "Sounds good! I'll leave them on the front porch in a bag. See you then 🍅", timestamp: "2026-07-01T12:00:00" },
      { message_id: 5, thread_id: 1, sender_user_id: 2, content: "Quick question — are these heirloom or regular?", timestamp: "2026-07-02T09:00:00" },
      { message_id: 6, thread_id: 1, sender_user_id: 1, content: "They're heirloom! Mix of Cherokee Purple and Brandywine. Really flavorful.", timestamp: "2026-07-02T09:15:00" },
      { message_id: 7, thread_id: 1, sender_user_id: 2, content: "Oh perfect, those are my favorites. I'll definitely be there at 3. Should I bring my own bag?", timestamp: "2026-07-02T09:20:00" },
      { message_id: 8, thread_id: 1, sender_user_id: 1, content: "I'll have them bagged already, don't worry about it. See you soon!", timestamp: "2026-07-02T09:30:00" },
    ],
  },
  {
    thread_id: 2,
    ...
    participant_ids: [3, 2],
    messages: [
      { message_id: 9, thread_id: 2, sender_user_id: 2, content: "Hey Rose! Could I grab 5 of the Meyer lemons? I want to make lemonade this weekend.", timestamp: "2026-07-01T14:00:00" },
      { message_id: 10, thread_id: 2, sender_user_id: 3, content: "Of course! They're really juicy this year. Can you pick up Saturday morning?", timestamp: "2026-07-01T14:30:00" },
      { message_id: 11, thread_id: 2, sender_user_id: 2, content: "Saturday morning works. What time?", timestamp: "2026-07-01T15:00:00" },
      { message_id: 12, thread_id: 2, sender_user_id: 3, content: "How about 10am? I'll have them in a bag by the front steps at 3142 Woodlawn Dr.", timestamp: "2026-07-01T15:15:00" },
      { message_id: 13, thread_id: 2, sender_user_id: 2, content: "Perfect, see you then! Thanks 🍋", timestamp: "2026-07-01T15:20:00" },
      { message_id: 14, thread_id: 2, sender_user_id: 3, content: "By the way, I also have some extra basil if you want some. Goes great with lemonade as a garnish!", timestamp: "2026-07-02T08:00:00" },
      { message_id: 15, thread_id: 2, sender_user_id: 2, content: "Oh yes please! That sounds amazing. I'll take whatever you have extra.", timestamp: "2026-07-02T08:15:00" },
      { message_id: 16, thread_id: 2, sender_user_id: 3, content: "Done! I'll add a small bunch to the bag. See you tomorrow at 10 🌿", timestamp: "2026-07-02T08:20:00" },
    ],
  },
  {
    thread_id: 3,
    ...
    participant_ids: [1, 4],
    messages: [
      { message_id: 17, thread_id: 3, sender_user_id: 4, content: "Hi Lily, I'd like 2 jars of strawberry jam for the food pantry. Is that possible?", timestamp: "2026-06-21T09:00:00" },
      { message_id: 18, thread_id: 3, sender_user_id: 1, content: "Absolutely! Happy to help the pantry. I can have them ready this afternoon.", timestamp: "2026-06-21T09:30:00" },
      { message_id: 19, thread_id: 3, sender_user_id: 4, content: "Wonderful. I'll swing by around 4pm. Thank you so much!", timestamp: "2026-06-21T10:00:00" },
      { message_id: 20, thread_id: 3, sender_user_id: 1, content: "No problem at all! The pantry does great work. Front porch as usual.", timestamp: "2026-06-21T10:15:00" },
      { message_id: 21, thread_id: 3, sender_user_id: 4, content: "Just picked them up — they look beautiful. Our families are going to love these.", timestamp: "2026-06-21T16:30:00" },
      { message_id: 22, thread_id: 3, sender_user_id: 1, content: "So glad! Let me know anytime you need more. I'm making another batch next week 🍓", timestamp: "2026-06-21T17:00:00" },
      { message_id: 23, thread_id: 3, sender_user_id: 4, content: "That would be great. We go through jam quickly. I'll keep an eye on your listings.", timestamp: "2026-06-21T17:15:00" },
    ],
  },
  {
    thread_id: 4,
    ...
    participant_ids: [1, 5],
    messages: [
      { message_id: 24, thread_id: 4, sender_user_id: 1, content: "Hi Malia! I saw your lilikoi listing. Could I get 5 of them?", timestamp: "2026-07-02T11:00:00" },
      { message_id: 25, thread_id: 4, sender_user_id: 5, content: "Hey Lily! Of course — they're super ripe right now. When can you pick up?", timestamp: "2026-07-02T11:30:00" },
      { message_id: 26, thread_id: 4, sender_user_id: 1, content: "I could come by tomorrow afternoon. Does 2pm work?", timestamp: "2026-07-02T11:45:00" },
      { message_id: 27, thread_id: 4, sender_user_id: 5, content: "2pm is perfect. I'm at 342 Kawailoa Rd — just come to the front lanai. They'll be in a paper bag.", timestamp: "2026-07-02T12:00:00" },
      { message_id: 28, thread_id: 4, sender_user_id: 1, content: "Awesome, thank you! I'm making lilikoi butter with them 😋", timestamp: "2026-07-02T12:05:00" },
      { message_id: 29, thread_id: 4, sender_user_id: 5, content: "Oh that sounds so good! If you have extra I'd love to trade for some 😄", timestamp: "2026-07-02T12:10:00" },
    ],
  },
];

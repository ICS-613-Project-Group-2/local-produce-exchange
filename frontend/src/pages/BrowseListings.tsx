...
export default function BrowseListings() {
  ...
  useEffect(() => {
    // Deferred so the initial setState calls in loadListings don't run
...
function ListingCard({ listing, viewMode }: { listing: ListingResponse; viewMode: ViewMode }) {
  // Date.now() can't be called directly in the render body (impure). Reading
  // it via a lazy useState initializer means it's evaluated once on mount
  // rather than on every render, which satisfies react-hooks/purity.

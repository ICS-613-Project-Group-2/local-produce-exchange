  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        getClaimsForListing(listingData.listing_id)
          .then((c) => {
    ...
    // Deferred so the initial setState calls happen outside the effect's
    // synchronous execution (avoids react-hooks/set-state-in-effect).
    queueMicrotask(() => {
      void loadData();
    });
